...
define gui.label_text_size = 36   # já era múltiplo de 4

## O tamanho do texto na tela de notificação.
define gui.notify_text_size = 24  # já era múltiplo de 4

## O tamanho do título do jogo.
define gui.title_text_size = 76   # próximo múltiplo de 4 a partir de 75
